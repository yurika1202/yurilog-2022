    ...
    <header class="ly_header">
        <div class="ly_header_inner is_openNav">
            ...
            <nav class="bl_headerNav">
                ...
                <button class="bl_header_navBtn el_circleBtn el_btn_hover__bound" id="js_drawerBtn" type="button" aria-expanded="false" aria-label="メニューを開く" aria-controls="headerNav">
